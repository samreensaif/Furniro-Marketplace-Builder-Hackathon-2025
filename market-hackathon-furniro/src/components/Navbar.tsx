...
//   return (
//     <nav className="relative w-full bg-red-500  z-50">
//       {/* Main container for Navbar */}
//       <div className="max-w-[1286px] bg-yellow-300 mx-auto px-4 exsm:px-2 xsm:px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-14 flex items-center gap-24 h-[41px] mt-[29px]">
        
//         {/* Logo Section */}
//         <div className="flex items-center bg-blue-300 gap-10 exsm:mr-0 xsm:ml-[50px] sm:ml-[80px] md:ml-[100px] lg:ml-[120px] xl:ml-[140px] 2xl:ml-[160px]">
//           <h1 className="exsm:text-[20px] xsm:text-[25px] sm:text-[30px] md:text-[35px]   font-bold font-montserrat text-black flex items-center gap-4">
//             <div>
//               <Image src="/logo1.png" alt={'Logo'} height={32} width={50} 
//                 className='exsm:w-[30px] exsm:h-[20px] xsm:w-[35px] xsm:h-[25px] sm:w-[40px] sm:h-[30px] md:w-[45px] md:h-[35px] lg:w-[50px] lg:h-[40px] ' />
//             </div>
//             Furniro
//           </h1>
//         </div>
