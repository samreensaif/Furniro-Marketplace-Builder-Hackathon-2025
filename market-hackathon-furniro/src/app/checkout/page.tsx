...
//   const [carrierId, setCarrierId] = useState("se-1576443");
...
//     {/* Header */}
//     <h2 className="text-2xl font-bold text-gray-800 text-center">Shipping Information</h2>
...
//                 <Link href={`/confirmation?productName=${productName}`}>
