    ...
    <div className="flex flex-col">
      ...
      <p className="text-gray-400">{item.relatedPostDate}</p>
        ...
        <div className="flex gap-4 items-center justify-center my-8">
          <Button className="w-12 h-12 text-lg bg-white text-black hover:bg-[#b88e2f]">1</Button>
          <Button className="w-12 h-12 text-lg bg-white text-black hover:bg-[#b88e2f]">2</Button>
          <Button className="w-12 h-12 text-lg bg-white text-black hover:bg-[#b88e2f]">3</Button>
